...
//
//	final AddModelContext ctx;
//
//	final FkeyPropertyVisitor pv;
//
//	public AddForeignKeysVisitor(boolean addMode, AddModelContext ctx) {
//		this.ctx = ctx;
...
//
//		public FkeyPropertyVisitor(boolean addMode, AddForeignKeysVisitor parent, AddModelContext ctx) {
